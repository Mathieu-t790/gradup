package app.mata.gradup.concurrency;

import static app.mata.gradup.concurrency.ThreadRenamer.getRandomSubThreadNamePrefixFrom;
import static app.mata.gradup.concurrency.ThreadRenamer.renameThread;
