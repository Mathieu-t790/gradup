package app.mata.gradup.endpoint.event.consumer;

import app.mata.gradup.PojaGenerated;
import app.mata.gradup.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("app.mata.gradup.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "app.mata.gradup.service.event."
