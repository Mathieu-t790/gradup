...
import static app.mata.gradup.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import app.mata.gradup.PojaGenerated;
import app.mata.gradup.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "app.mata.gradup.event1";
    return "app.mata.gradup.event2";
  }
}
