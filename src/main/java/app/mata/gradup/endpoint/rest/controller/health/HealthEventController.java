package app.mata.gradup.endpoint.rest.controller.health;

import static app.mata.gradup.endpoint.rest.controller.health.PingController.KO;
import static app.mata.gradup.endpoint.rest.controller.health.PingController.OK;
import static java.util.UUID.randomUUID;

import app.mata.gradup.PojaGenerated;
import app.mata.gradup.endpoint.event.EventProducer;
import app.mata.gradup.endpoint.event.model.DurablyFallibleUuidCreated1;
import app.mata.gradup.endpoint.event.model.DurablyFallibleUuidCreated2;
import app.mata.gradup.endpoint.event.model.UuidCreated;
