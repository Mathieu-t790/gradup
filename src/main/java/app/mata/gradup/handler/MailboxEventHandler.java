...
import static app.mata.gradup.concurrency.ThreadRenamer.renameWorkerThread;
import static java.lang.Runtime.getRuntime;
import static java.lang.System.getenv;
import static java.lang.Thread.currentThread;

import app.mata.gradup.PojaGenerated;
import app.mata.gradup.endpoint.EndpointConf;
import app.mata.gradup.endpoint.event.EventConf;
import app.mata.gradup.endpoint.event.consumer.EventConsumer;
import app.mata.gradup.endpoint.event.consumer.model.ConsumableEvent;
import app.mata.gradup.endpoint.event.consumer.model.ConsumableEventTyper;
...
public class MailboxEventHandler implements RequestHandler<SQSEvent, String> {
  ...
  private ConfigurableApplicationContext applicationContext(String... args) {
    SpringApplication application = new SpringApplication(app.mata.gradup.GradUpApplication.class);
